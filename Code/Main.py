...
# Open the Image File
bg = ImageTk.PhotoImage(file="probackground.png")

# Create a Canvas
canvas = Canvas(main, width=700, height=3500)
...
def resize_image(e):
   ...
   image = Image.open("probackground.png")
...
main.bind("<Configure>", resize_image)
global filename
